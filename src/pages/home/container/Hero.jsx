  ...
  return (
    <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
      <div className="mt-10 lg:w-1/2">
        ...
        Explore a spectrum of menstrual insights, from health and hygiene to societal perspectives, empowering you with knowledge and fostering an open dialogue
        </p>
